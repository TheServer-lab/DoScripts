...
make folder "C:\Server-lab\program"

say "Downloading package..."

download "https://yourdomain.com/program.zip" to "C:\Server-lab\program.zip"

say "Extracting package..."

execute_command "powershell" "-Command" "Expand-Archive -Path 'C:\Server-lab\program.zip' -DestinationPath 'C:\Server-lab\program' -Force"

say "Cleaning up..."

delete "C:\Server-lab\program.zip"

say ""
say "========================================="
say "Installation Complete!"
say "Installed to:"
say "C:\Server-lab\program"
say "========================================="
